...
#reloading the image again and again in order to get a new image every time 
while True:
    ...
    if contours:
        ...
        if cv2.contourArea(max_contour)>5000:
           #cv2.rectangle(frame,(x,y),(x+w,y+h),(0,255,255),2)
            ...
            #Scanning a doc and saving it 
            if cv2.waitKey(1)==ord('s'):
                img=cv2.imread('myScannedDocs.pdf',cv2.IMREAD_COLOR)
